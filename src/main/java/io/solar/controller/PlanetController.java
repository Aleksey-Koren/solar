...
//    public Planet save(@RequestBody Planet planet, @AuthData User user, Transaction transaction) {
//        if (!AuthController.userCan(user, "edit-planets", transaction)) {
...
//    @RequestMapping("{id}")
//    public Planet get(@PathVariable("id") Long id, Transaction transaction) {
//        Query query = transaction.query("select * from planets where id = :id");
//        query.setLong("id", id);
//        List<Planet> existing = query.executeQuery(new PlanetMapper());
...
//    }
    ...
    public Page<PlanetDTO> findAll(@PageableDefault() Pageable pageable) {
