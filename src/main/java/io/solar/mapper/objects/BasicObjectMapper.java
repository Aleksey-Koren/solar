...
@Service
public class BasicObjectMapper implements EntityDtoMapper<BasicObject, BasicObjectViewDto> {
    ...
    @Autowired
    public BasicObjectMapper(ObjectTypeDescriptionRepository objectTypeDescriptionRepository,
